...
public class KillListener implements Listener {
    ...
    // blood ფერები — მხოლოდ წითელი/მუქი წითელი
    ...
    // შავი outline — მუქი, თითქმის შავი
    ...
    private void playBloodAnimation(Location loc) {
        ...
        // Phase 1 — instant burst: blood + შავი outline
        ...
        // Phase 2 — blood drips ring + შავი outline
        new BukkitRunnable() {
            int tick = 0;
            @Override
            public void run() {
        ...
        // Phase 3 — final blood + შავი explosion
        new BukkitRunnable() {
            @Override
            public void run() {
