...
public class SwordBuilder {
    ...
    public static ItemStack build() {
        ...
        // სახელი: მთლიანად DARK_RED (სისხლის ფერი), bold
        meta.setDisplayName(
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "⚔ Critical Fury"
        );
        ...
        meta.setLore(Arrays.asList(
            ...
            ChatColor.DARK_RED + "━━━━━━━━━━━━━━━━━━━━",
            ChatColor.DARK_RED + " ⚡ Sharpness V",
            ChatColor.DARK_RED + " ⚡ Sweeping Edge III",
            ChatColor.DARK_RED + " ⚡ Mending",
            ChatColor.DARK_RED + "━━━━━━━━━━━━━━━━━━━━",
