...
public class SwordBuilder {
    ...
    public static ItemStack build() {
        ...
        // სახელი: DARK_RED + BLACK შერეული
        meta.setDisplayName(
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "⚔ " +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "C"  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "r"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "i"  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "t"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "i"  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "c"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "a"  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "l"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + " "  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "F"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "u"  +
            ChatColor.DARK_RED + "" + ChatColor.BOLD + "r"  +
            ChatColor.BLACK    + "" + ChatColor.BOLD + "y"
        );
